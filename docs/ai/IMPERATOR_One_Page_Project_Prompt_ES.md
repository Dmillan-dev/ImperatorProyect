...
La guia de sprints de Phase 2 vive en `agents/phase2/README.md`. Usala cuando el fundador autorice Platform Foundation: Sprint 0 Contract Gate, Sprint 1 project shell, Sprint 2 Java Domain Foundation, Sprint 3 Application Layer Foundation, Sprint 4 PostgreSQL foundation, Sprint 5 API route shells, Sprint 6 JWT/RBAC, Sprint 7 Python AI-provider foundation, Sprint 8 React shell, Sprint 9 Docker local foundation, Sprint 10 observability y Sprint 11 CI/R&D evidence. Ningun agente puede generar mas de un modulo por iteracion. El gate actual vive en `docs/architecture/38_Sprint_0_Contract_Gate_Report.md` y autoriza solo Sprint 1 - Repository and Project Shell.
