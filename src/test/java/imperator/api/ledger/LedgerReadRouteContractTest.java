...
class LedgerReadRouteContractTest {
    ...
    private static final Set<String> DEFERRED_COMMAND_ROUTES = Set.of(
    ...
    @Test
    void keepsTheBroaderLedgerEntryDetailRouteUnavailable()
            throws IOException, InterruptedException {
    ...
    @Test
    void keepsTheDeferredLedgerCommandsUnavailable()
            throws IOException, InterruptedException {
        for (String route : DEFERRED_COMMAND_ROUTES) {
            HttpResponse<String> response =
