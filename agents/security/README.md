...
-> Sprint 4.4 - Observability implementation: AUTHORIZED / CURRENT
```
...
D096 is frozen. Sprint 4.4 implementation is the sole authorized current gate
and must preserve every existing security authority.
