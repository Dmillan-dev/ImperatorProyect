...
2. Single wedge still clear (Cross-platform Decision Traceability)?
...
- Entry wedge: Cross-platform Decision Traceability for incidents and audits.
- Land-and-expand sequence: Platform → Security → Compliance → FinOps → Legal → Executive.